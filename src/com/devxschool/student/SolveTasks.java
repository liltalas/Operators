...
//        Validation.testProfit(jake, phil, ryan, tom, bill, eachDailyProfit);
        ...
        //TODO implement your code here...
        System.out.println("Write a program that takes number of minutes from user and " +
                "converts the number to Years and Days");
        System.out.println("Input the number of minutes: ");
        long min = sc.nextLong();
        long totalMinInYear = 60 * 24 * 365;
        int years = (int)(min / totalMinInYear); // typecasting from long to int
        int remainingMins = (int)(min % totalMinInYear); // we'll get remaining mins

        int days = remainingMins / 1440; // 60 * 24 = 1440
